...
const Login = () => {
  return (
    <div className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-400">
      <div className="w-full hidden md:block">Should be a background</div>
      <div className="w-full max-w-md space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold tracking-tight">
            Sign in to save your movies
          </h2>
          <p className="mt-2 text-center text-sm text-gray-80000">
            Or
            <Link
              href="#"
